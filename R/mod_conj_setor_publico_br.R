                 ...
                 column(
                   ...
                   descriptionBlock(
                     number = paste("R$", round(
                       (tail(series$ResultadoBR$value / 1000, 1) - head(tail(series$ResultadoBR$value / 1000, 2), 1)), 1
                     ), "bi"),
                     ...
                     header = paste0(" R$", round(tail(series$ResultadoBR$value / 1000, 1), 1), " bi", " (", tail(months(series$ResultadoBR$date), 1), ")"),
           ...
           box(
             ...
             footer = fluidRow(
               column(
                 ...
                 descriptionBlock(
                   number = paste("R$", round(
                     (tail(series$DividaBrutaBR$value / 1000, 1) - head(tail(series$DividaBrutaBR$value / 1000, 2), 1)), 1
                   ), "bi"),
