...
Nesse sentido, a taxa de desocupação segue caindo desde março desse ano, chegando a 12,6% no terceiro trimestre de 2021, após atingir o maior nível da 
...
Apesar disso, o número de desempregados ainda é muito alto e totaliza 13,5 milhões de pessoas.
 O saldo líquido de emprego formal ficou positivo em 324.112 vagas em novembro, 
 ante previsão do mercado, de criação de 216 mil vagas.
...
\subsection{Espiríto Santo} 
 \vspace{0.5cm}
Em relação ao Estado, o número de novas admissões foi de 35.000 no mês de outubro,
 ante as 26.774 demissões, o saldo total foi de 8.535, variação de 1,01% em relação ao
  mês anterior, uma das maiores variações entre as capitais, atrás apenas de Amapá (1,39%).  
...
geom_line(
  ...
  scale_x_date(
    date_labels = "%B/%Y",
    date_breaks = "1 month",
    limits = as.Date(c("2021-01-01", "2021-07-01"))) +
  coord_cartesian(ylim = c(900, 8000)) +
labs(
y = "unidades",
x = "",
...
No que diz respeito ao acumulado do ano o Espiríto Santo obteve aumento de  7,84% no saldo de empregos.
...
No entanto, é preciso ter cautela na elevação da SELIC, visto que, ela impacta também no 
...
A alta da Selic deveria proporcionar uma queda na cotação do dólar, já que
...
geom_line(
  ...
  scale_x_date(
    date_labels = "%m/%y",
    date_breaks = "6 month",
    limits = as.Date(c("2015-01-01", "2021-12-01"))) +
