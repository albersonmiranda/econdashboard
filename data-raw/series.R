...
ResultadoBR.PIB = BETSget(5507, data.frame = TRUE, from = "2001-12-01") #NFSP sem desvalorização cambial - Fluxo acumulado no ano - Resultado primário (%PIB)
...
DividaBrutaBR.PIB = BETSget(13762, data.frame = TRUE, from = "2006-12-01") #Dívida bruta do Governo Geral - % do PIB
